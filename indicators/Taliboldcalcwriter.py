        ...
        try:
            for interval in intervals:
                ...
                if interval == '30MINUTE' or interval =='1HOUR' or interval=='4HOUR':
                    ...
                    start = len(result.pricetime)
                if len(result.pricetime) < 500:
                    start = len(result.pricetime)
                for i in range(len(result.pricetime) - start , len(result.pricetime)):
            ...
            print(E)
            print(f'{interval} {pair} {len(result.pricetime)}' )
            continue
